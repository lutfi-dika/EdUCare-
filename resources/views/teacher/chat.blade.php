...
@section('title', 'EduCare - Chat Guru')
...
@section('content')
<div class="mb-6">
    <h1 class="text-2xl font-bold text-[#111827] dark:text-[#ededed]" data-i18n="t_msg.title">Chat dengan {{ $otherUser->name }}</h1>
    ...
    <div class="flex-1 overflow-y-auto p-4 space-y-3" id="chatMessages">
        ...
        @if($messages->isEmpty())
            <div class="flex items-center justify-center h-full">
                <p class="text-sm text-[#64748B] dark:text-[#a3a3a3]" data-i18n="t_msg.mulai">Mulai percakapan...</p>
            </div>
        @endif
    </div>
