...
@section('title', 'EduCare - Tambah Quiz')
...
<div class="max-w-2xl">
    <div class="mb-8">
        <h1 class="text-2xl font-bold text-[#111827] dark:text-[#ededed]">Tambah Quiz Baru</h1>
        <p class="text-[#64748B] dark:text-[#a3a3a3] mt-1">Isi form berikut untuk membuat quiz baru.</p>
    </div>
    ...
    <div class="bg-white rounded-2xl border border-[#E2E8F0] p-6 sm:p-8 dark:bg-[#1a1a1a] dark:border-[#2a2a2a] transition-colors duration-200">
        <form action="{{ url('/teacher/quizzes') }}" method="POST">
            @csrf
            <div class="mb-5">
            ...
            <div class="mb-5">
                ...
                <textarea name="description" rows="3" required
                    class="w-full px-4 py-3 rounded-xl border border-[#E2E8F0] focus:border-[#2563EB] focus:ring-2 focus:ring-[#2563EB]/20 outline-none transition-all text-sm dark:bg-[#111111] dark:border-[#2a2a2a] dark:text-[#ededed]"
                    placeholder="Deskripsi singkat quiz"></textarea>
            </div>
            ...
            <div class="flex gap-3">
                ...
                <button type="submit" class="px-6 py-3 bg-[#2563EB] text-white font-medium rounded-xl hover:bg-[#1D4ED8] transition-colors">Simpan Quiz</button>
            </div>
        </form>
    </div>
</div>
