<aside id="dashboard-sidebar" class="fixed top-0 left-0 h-full w-[260px] bg-white border-r border-[#E2E8F0] z-50 transform -translate-x-full lg:translate-x-0 transition-transform duration-300 dark:bg-[#1a1a1a] dark:border-[#2a2a2a]">
    ...
    <nav class="p-4 flex flex-col gap-1">
        <p class="text-xs font-semibold text-[#94A3B8] uppercase tracking-wider px-4 mb-2">Guru</p>
        <a href="{{ url('/teacher') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium transition-colors {{ request()->is('teacher') && !request()->is('teacher/*') ? 'bg-[#EFF6FF] text-[#2563EB] dark:bg-[#2563EB]/15 dark:text-[#60a5fa]' : 'text-[#64748B] hover:bg-gray-50 dark:text-[#a3a3a3] dark:hover:bg-[#2a2a2a]' }}">
        ...
        <a href="{{ url('/teacher/materials') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium transition-colors {{ request()->is('teacher/materials*') ? 'bg-[#EFF6FF] text-[#2563EB] dark:bg-[#2563EB]/15 dark:text-[#60a5fa]' : 'text-[#64748B] hover:bg-gray-50 dark:text-[#a3a3a3] dark:hover:bg-[#2a2a2a]' }}">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" /></svg>
            Materi
        </a>
        <a href="{{ url('/teacher/quizzes') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium transition-colors {{ request()->is('teacher/quizzes*') ? 'bg-[#EFF6FF] text-[#2563EB] dark:bg-[#2563EB]/15 dark:text-[#60a5fa]' : 'text-[#64748B] hover:bg-gray-50 dark:text-[#a3a3a3] dark:hover:bg-[#2a2a2a]' }}">
        ...
        <a href="{{ url('/teacher/students') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium transition-colors {{ request()->is('teacher/students*') ? 'bg-[#EFF6FF] text-[#2563EB] dark:bg-[#2563EB]/15 dark:text-[#60a5fa]' : 'text-[#64748B] hover:bg-gray-50 dark:text-[#a3a3a3] dark:hover:bg-[#2a2a2a]' }}">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5-9a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0z" /></svg>
            Siswa
        </a>
        <a href="{{ url('/teacher/statistics') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium transition-colors {{ request()->is('teacher/statistics*') ? 'bg-[#EFF6FF] text-[#2563EB] dark:bg-[#2563EB]/15 dark:text-[#60a5fa]' : 'text-[#64748B] hover:bg-gray-50 dark:text-[#a3a3a3] dark:hover:bg-[#2a2a2a]' }}">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" /></svg>
            Statistik
        </a>
        <a href="{{ url('/teacher/calendar') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium transition-colors {{ request()->is('teacher/calendar*') ? 'bg-[#EFF6FF] text-[#2563EB] dark:bg-[#2563EB]/15 dark:text-[#60a5fa]' : 'text-[#64748B] hover:bg-gray-50 dark:text-[#a3a3a3] dark:hover:bg-[#2a2a2a]' }}">
        ...
        <a href="{{ url('/teacher/messages') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium transition-colors {{ request()->is('teacher/messages*') ? 'bg-[#EFF6FF] text-[#2563EB] dark:bg-[#2563EB]/15 dark:text-[#60a5fa]' : 'text-[#64748B] hover:bg-gray-50 dark:text-[#a3a3a3] dark:hover:bg-[#2a2a2a]' }}">
        ...
        <a href="{{ url('/teacher/export') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium transition-colors {{ request()->is('teacher/export*') ? 'bg-[#EFF6FF] text-[#2563EB] dark:bg-[#2563EB]/15 dark:text-[#60a5fa]' : 'text-[#64748B] hover:bg-gray-50 dark:text-[#a3a3a3] dark:hover:bg-[#2a2a2a]' }}">
