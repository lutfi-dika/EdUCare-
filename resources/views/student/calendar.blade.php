...
@section('title', 'EduCare - Kalender Saya')
...
@section('content')
<div class="mb-8">
    <h1 class="text-2xl font-bold text-[#111827] dark:text-[#ededed]" data-i18n="s_cal.title">Kalender Kegiatan</h1>
    <p class="text-[#64748B] dark:text-[#a3a3a3] mt-1" data-i18n="s_cal.sub">Jadwal belajar kamu.</p>
</div>
...
<div class="grid lg:grid-cols-3 gap-6">
    ...
    <div>
        <div class="bg-white rounded-2xl border border-[#E2E8F0] dark:bg-[#1a1a1a] dark:border-[#2a2a2a] p-6">
            <h3 class="font-bold text-[#111827] dark:text-[#ededed] mb-4" data-i18n="s_cal.terbaru">Kegiatan Terbaru</h3>
            <div class="space-y-3 max-h-[500px] overflow-y-auto">
                ...
                @empty
                    <p class="text-sm text-[#64748B] dark:text-[#a3a3a3] text-center py-4" data-i18n="s_cal.belum_ada">Belum ada kegiatan.</p>
                @endforelse
            </div>
        </div>
    </div>
